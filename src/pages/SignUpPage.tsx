    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#F8F9FA] dark:bg-zinc-950 transition-colors font-sans relative">
      ...
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-display font-black italic uppercase text-[#1A1A1A] dark:text-white mb-2 tracking-tight">Create Account</h1>
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Join HoopStats and start tracking.</p>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-3">
          <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400">
            Already have an account? <button onClick={() => navigate('/login')} className="text-brand-navy dark:text-brand-orange font-bold hover:underline uppercase tracking-wider ml-1 cursor-pointer">Sign in</button>
          </p>
